...
import '../Style/Weightlosspage.css'; // Import the CSS file
import img4 from '../image/weightloss1.jpg'; // Import the image for the left side
import img5 from '../image/weightloss2.jpg'; // Import the image for the right side
import img6 from '../image/moneyback.jpg'; // Import the new image for the end
            ...
            if (validationData.message === 'Payment verified successfully') {
              ...
              const purchaseResponse = await fetch('http://localhost:3001/api/purchase', {
                ...
                body: JSON.stringify({
                  ...
                  courseName: 'FitX 120 Weight Loss Program',
                }),
              });
  ...
  return (
    <div className="weight-loss-container">
      <div className="weight-loss-heading">
        Lose your belly fat & gain confidence in just 120 days
      </div>
      <div className="weight-loss-details">
        The Step-by-Step 120 days transformation program that will guide you to lose fat through home workouts or gym workouts combined with 300+ diet plans.
      </div>

      <div className="weight-loss-link">
        {/* Link to payment process */}
        <Link to="#" onClick={handleClick} className="weight-loss-link-text">
          CLICK HERE TO JOIN FITX120
        </Link>
        <div className="weight-loss-subheading">
          Can’t lose weight even after trying for years? Here’s why
        </div>
      </div>
      <div className="weight-loss-images">
        <div className="weight-loss-image-container">
          <img src={img4} alt="Weight Loss Transformation" className="weight-loss-image-left" />
          <div className="weight-loss-image-text-left">
            You don’t have someone who can guide you in the right direction towards your fitness goals.
          </div>
        </div>
        <div className="weight-loss-image-container">
          <img src={img5} alt="Weight Loss Program" className="weight-loss-image-right" />
          <div className="weight-loss-image-text-right">
            You are confused & overwhelmed with too much information on the internet, & don't know how to start your fitness journey.
          </div>
        </div>
      </div>
      ...
      <div className="modules-container">
        ...
        <div className="module">
          ...
          Follow structured workout plans for effective fat loss and muscle gain.
        </div>
        <div className="module">
          <strong>Module 7: Supplements</strong><br />
          Understand the role of supplements in body recomposition.
        </div>
        <div className="module">
          <strong>Module 8: Progress Tracking</strong><br />
          Learn how to track your progress and make necessary adjustments.
        </div>
      </div>

      {/* Money Back Guarantee Section */}
      <div className="money-back-container">
        <img src={img6} alt="Money Back Guarantee" className="money-back-image" />
