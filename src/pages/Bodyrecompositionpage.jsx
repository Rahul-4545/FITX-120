...
import '../Style/Bodyrecompositionpage.css'; // Import the CSS file
import img10 from '../image/weightloss1.jpg'; // Import the image for the left side
import img11 from '../image/weightloss2.jpg'; 
import img12 from '../image/moneyback.jpg'; 

const BodyRecomposition = () => {
            ...
            if (validationData.message === 'Payment verified successfully') {
              ...
              const purchaseResponse = await fetch('http://localhost:3001/api/purchase', {
                ...
                body: JSON.stringify({
                  ...
                  courseName: 'FitX 120 BodyRecomposition',
                }),
              });
  ...
  return (
    <div className="body-recomp-container">
      <div className="body-recomp-heading">
        Transform Your Body & Achieve Balance in 120 Days
      </div>
      <div className="body-recomp-details">
        The Step-by-Step 120 days program that will guide you to reduce fat and gain muscle through balanced workouts and diet plans tailored for your body.
      </div>

      <div className="body-recomp-link">
        <a href="#" className="body-recomp-link-text" onClick={handlePayment}>
          {loading ? 'Processing Payment...' : 'CLICK HERE TO JOIN FITX120'}
        </a>
        <div className="body-recomp-subheading">
          Struggling to achieve the right balance between fat loss and muscle gain? Here’s why
        </div>
      </div>

      <div className="body-recomp-images">
        <div className="body-recomp-image-container">
          <img src={img10} alt="Body Recomposition Transformation" className="body-recomp-image-left" />
          <div className="body-recomp-image-text-left">
            You don’t have a structured plan to guide you towards a balanced body transformation.
          </div>
        </div>
        <div className="body-recomp-image-container">
          <img src={img11} alt="Body Recomposition Program" className="body-recomp-image-right" />
          <div className="body-recomp-image-text-right">
            You are overwhelmed with too much information and struggle to balance muscle gain with fat loss.
          </div>
        </div>
      </div>
      ...
      <div className="modules-container">
        ...
        <div className="module">
          <strong>Module 4: Nutrition and Diet Plans</strong><br />
          Get customized nutrition and diet plans to support your transformation.
        </div>
        <div className="module">
          <strong>Module 5: Exercise Routines</strong><br />
          Follow a structured exercise routine designed for body recomposition.
        </div>
        <div className="module">
          <strong>Module 6: Tracking Progress</strong><br />
          Learn how to track and measure your progress effectively.
        </div>
      </div>

      {/* Money Back Guarantee Section */}
      <div className="money-back-container">
        <img src={img12} alt="Money Back Guarantee" className="money-back-image" />
        <div className="money-back-content">
          <div className="money-back-heading">Money Back Guarantee</div>
          <div className="money-back-text">
            We are confident that our program will deliver results. If you don't see improvement within 30 days, we offer a full refund.
          </div>
        </div>
        {/* New Section */}
